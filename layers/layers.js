...
lyr_OpenStreetMap_0.setVisible(true);lyr_KotaManado_1.setVisible(true);lyr_Kelurahan_2.setVisible(true);lyr_Kecamatan_3.setVisible(true);lyr_Titik_4.setVisible(true);lyr_Bangunan_5.setVisible(true);lyr_Fasilitas_Ekonomi_6.setVisible(true);lyr_Jalan_Utama_7.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_KotaManado_1,lyr_Kelurahan_2,lyr_Kecamatan_3,lyr_Titik_4,lyr_Bangunan_5,lyr_Fasilitas_Ekonomi_6,lyr_Jalan_Utama_7];
...
lyr_Kecamatan_3.set('fieldAliases', {'kd_propins': 'kd_propins', 'kd_dati2': 'kd_dati2', 'kd_kecamat': 'kd_kecamat', 'nm_kecamat': 'nm_kecamat', });
...
lyr_Kecamatan_3.set('fieldImages', {'kd_propins': 'TextEdit', 'kd_dati2': 'TextEdit', 'kd_kecamat': 'TextEdit', 'nm_kecamat': 'TextEdit', });
...
lyr_Kecamatan_3.set('fieldLabels', {'kd_propins': 'no label', 'kd_dati2': 'no label', 'kd_kecamat': 'no label', 'nm_kecamat': 'no label', });
...
lyr_Jalan_Utama_7.on('precompose', function(evt) {
